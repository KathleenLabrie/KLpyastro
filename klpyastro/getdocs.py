...
def move_docs(destination):
    ...
    destination : str
        ...
        copied to 'destination/share/klpyastro'
    """

    dirname = resource_filename(Requirement.parse('klpyastro'),
                            os.path.join('share', 'klpyastro'))
    sub_destination = os.path.join(destination, 'klpyastro')
